...
class Game extends JPanel {
    ...
    private void render(Graphics g) {
        ...
        if (status == GameStatus.NOT_STARTED) {
          drawCenteredString(g2d, "Welcome to", FONT_XL, 200);
          drawCenteredString(g2d, "Snake Game", FONT_XL, 300);
          drawCenteredString(g2d, "Any  key  to  start", FONT_M_ITALIC, 330);
        ...
        if (status == GameStatus.GAME_OVER) {
            drawCenteredString(g2d, "Enter to Again", FONT_M_ITALIC, 330);
            drawCenteredString(g2d, "OUT!", FONT_L, 300);
        }
        ...
        g2d.setColor(new Color(35, 75, 190));
